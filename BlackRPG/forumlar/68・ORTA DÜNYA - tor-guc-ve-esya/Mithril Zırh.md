...
Genç bir Elf prensi için dövülmüş mithril zırh gömleği. Smaug'un hazinesinden çıkıp Bilbo'ya, oradan Frodo'ya geçen, Shire'dan değerli zırh.
...
Mithril zırh, Cüce işçiliğiyle mithril'den örülmüş bir zincir zırh gömleğidir; Bilbo ve Frodo Baggins'e ait olmasıyla ünlüdür. Mithril, 'gerçek gümüş' olarak da bilinen, gümüşten daha güzel ve parlak, çelikten kat kat sağlam ama tüy gibi hafif, son derece nadir bir madendir. Başlıca Moria'da, Khazad-dûm'un derinliklerinde çıkarılırdı ve değeri altının çok üstündeydi.

Bu zırh, Erebor Seferi'nden çok önce genç bir Elf prensi için dövülmüştü ve mithril'den yapılmış eserlerin en ünlüsüdür. Küçük bir bedene göre yapıldığı için, ileride bir hobbite tam uyacaktı. Ejderha Smaug'un Yalnız Dağ'daki devasa hazinesinde duruyordu; oradan çıkarılıp, Erebor Kralı Thorin Meşekalkan tarafından bir minnet ifadesi olarak Bilbo Baggins'e armağan edildi.
...
- Saf mithril
- Hafif ama delinmez
- Elf prensi için yapıldı
- Smaug'un hazinesinden
- Frodo'nun canını kurtardı
