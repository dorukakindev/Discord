...
Archon'lar, Yanılsama'yı belli ilkeler ya da nitelikler üzerinden ayakta tutar; ve bu nitelikler, Kult'un kozmolojisinin dayandığı Kabala sistemine, yani Sephiroth yapısına bağlıdır. Her Archon, bu yapıdaki bir niteliği yönetir; örneğin belli bir Archon, baskıyı ve kontrolü temsil ederken, bir diğeri toplumsal düzeni, bir başkası ise korkuyu ya da uyumu temsil edebilir. Bu nitelikler aracılığıyla Archon'lar, insan toplumunu ve insan zihnini biçimlendirir; bizi uysal, uyuşuk ve uykuda tutan kuralları, korkuları ve bağımlılıkları beslerler.
