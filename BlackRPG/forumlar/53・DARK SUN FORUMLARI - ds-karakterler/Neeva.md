...
Neeva'nın gücü, sadece fiziksel değildir; o, keskin bir dövüş zekâsına, soğukkanlılığa ve sarsılmaz bir iradeye sahiptir. Arena meydanında Rikus ile yan yana dövüşürken, ikisi birlikte âdeta yenilmez bir ikili oluşturur; ama Neeva, asla Rikus'un gölgesinde kalan bir yardımcı değildir. O, kendi kararlarını veren, kendi yolunu çizen bağımsız bir karakterdir; köle olmanın ve bir savaş aracı olarak kullanılmanın aşağılanmasına, en az ortağı kadar öfke duyar, ve özgürlüğe en az onun kadar susamıştır. Bu güçlü iradesi, onu hem arenada hem de hayatta bir lider yapar.

Neeva'nın kaderi, Tyr'in özgürlük mücadelesiyle iç içe geçer. Şehrin ölümsüz tiranı Sihirbaz-Kral Kalak'a karşı düzenlenen isyanda, Neeva da Rikus, senatör Agis ve büyücü Sadira gibi kahramanların yanında yer alır. Bir gladyatör olarak ölümcül dövüş yeteneği, isyanın en tehlikeli anlarında paha biçilmez olur; o, Tyr'in zincirlerini kırmak için canını ortaya koyan kahramanlardan biridir. Mücadele boyunca, hem bir savaşçı olarak gücünü hem de bir birey olarak kararlılığını kanıtlar.
...
- Sihirbaz-Kral Kalak'a karşı düzenlenen isyana katıldı
