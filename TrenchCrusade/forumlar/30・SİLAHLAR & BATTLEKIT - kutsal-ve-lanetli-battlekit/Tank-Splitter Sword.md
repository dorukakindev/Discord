...
Tank-Yaran Kılıç (Tank-Splitter Sword), New Antioch Prensliği'nin yakın dövüşteki ham gücünün simgesidir. Adından da anlaşılacağı gibi bu, sıradan bir kılıç değil, iki elle taşınması gereken devasa bir savaş silahıdır; öyle ağır ve öyle keskindir ki, ismi gerçek bir iddiada bulunur: bu kılıç, bir tankın zırhını bile yarabilir. Oyun kurallarında iki elli bu silah, taşıyanına ek bir Yaralama Zarı ve Critical özelliği kazandırır; bir zırhlı düşmana vurduğunda ise Yaralama Zarları'ndan birini doğrudan altıya, yani en ölümcül sonuca sabitleyebilir. Bu, onu Trench Crusade'in en korkunç zırh delici yakın dövüş silahlarından biri yapar.
...
- İki elli ağır kılıç: +1 Yaralama Zarı ve Critical özelliği
- Zırhlı bir hedefe vurduğunda Yaralama Zarı'nın biri altıya sabitlenebilir
- Orikalkum alaşımlı, ilahi ışıkla yoğrulmuş çelikten dövülür
- Sıradan zırhın ve makine plakasının içinden geçer
