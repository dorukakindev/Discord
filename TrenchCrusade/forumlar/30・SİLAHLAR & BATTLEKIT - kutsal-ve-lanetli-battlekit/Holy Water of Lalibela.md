...
Bu kutsal suyun değeri, Trench Crusade'in acımasız doğasından gelir. Bu, yaraların kolayca öldürdüğü, enfeksiyonun ve kangrenin kurşun kadar ölümcül olduğu bir savaştır; siperlerin çamurunda, bir çizik bile zamanla bir adamı mezara götürebilir. Böyle bir dünyada şifa, paha biçilmez bir kaynaktır; ve Lalibela'nın Kutsal Suyu, o şifayı bir şişede taşır. Faithful bir warband için bu su, en değerli savaşçıyı ölümün eşiğinden geri çekebilir, bir kahramanın savaşa devam etmesini sağlayabilir. Ama tek kullanımlıktır; her damla değerlidir ve ne zaman harcanacağı kritik bir karardır.
...
- Kutsal Lalibela kaya kiliselerinin kutsanmış kaynağından gelir
- Tek kullanımlık, değerli bir tüketim emaneti
