...
- Tek kelimelik yazım düzeltmeleri: doğrudan <#1551588115540480020> üzerinden işlenir.
...
3. Metin, Discord'a yapıştırılacağı biçimde `

` ayraçlarıyla bölünmüş ve her mesaj 1800 karakterin altında olmalıdır.
4. Taslak açıldığında durum etiketi **Hazır** ile başlar; etiket değişiklikleri yalnızca editörler tarafından yapılır ve <#1551588112768045067> iş akışını izler.
...
**Durum etiketleri** (ayrıntı: <#1551588112768045067>)
Hazır · Kaynak Bekliyor · Kanon Kontrolünde · Revizyon Gerekli · Yayına Hazır

**Kanon etiketleri** (ayrıntı: <#1551588109857202218>)
...
2. Kaynak denetçisi <#1551588107592143021> listesini uygular; eksik varsa **Kaynak Bekliyor**.
...
5. Tüm denetimler geçildiğinde **Yayına Hazır**; yayın sonrası başlık kilitlenir, arşivlenir ve işlem <#1551588115540480020> ile <#1551588118023508078>'a kaydedilir.
