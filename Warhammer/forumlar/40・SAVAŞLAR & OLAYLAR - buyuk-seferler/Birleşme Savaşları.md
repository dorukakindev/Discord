...
İmparator'un, Çekişme Çağı'nın ardından parçalanmış Terra'yı tek bir yönetim altında birleştirmek için yürüttüğü kanlı fetih savaşları.

Birleşme Savaşları (the Unification Wars), İmparatorluğun gerçek doğum anıdır; İmparator'un, Çekişme Çağı'nın kaosundan çıkıp önce kendi ana gezegeni Terra'yı, ardından da galaksiyi birleştirme planının ilk adımıdır. Bu savaşlar, hem İmparator'un vizyonunun ihtişamını hem de yöntemlerinin acımasızlığını gösterir.
