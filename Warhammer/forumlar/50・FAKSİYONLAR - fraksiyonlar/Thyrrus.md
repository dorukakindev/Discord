...
Bilinmezlikle örtülü kseno uygarlığı; 'kazıkatanlar' olarak anılan, galaksinin en uç bölgelerinde görülen esrarengiz bir tür.

- **Kategori:** Xenos türü
- **Fraksiyon:** Bağımsız
- **Dönem:** Belirsiz
- **Köken:** Segmentum Obscurus'un dış bölgeleri
- **Teknik / Biyolojik Özellikler:** Kaynaklarda çok kollu, iskeletimsi varlıklar olarak betimlenir; gemileri ve amaçları anlaşılamamıştır.
