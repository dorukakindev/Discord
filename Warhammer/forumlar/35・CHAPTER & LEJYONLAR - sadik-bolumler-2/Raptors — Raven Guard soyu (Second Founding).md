...
Şan ve onur gösterisini ikinci plana atıp yalnızca sonuca bakan, gizlenme, keşif ve keskin nişancılığı ustalıkla birleştiren Chapter. Raptors, Codex Astartes'i mutlak dogma değil, etkili bir yönergeler bütünü olarak görür.

- **Kategori:** Successor Chapter — `sadik-bolumler-3`
- **Fraksiyon:** Adeptus Astartes (sadık)
- **Dönem:** Scouring'den M41 sonuna
- **Köken:** Founding: Second Founding. Gene-lineage: Raven Guard / Corvus Corax. Yurt: Chapter yurdunun konumunu gizli tutar; kaynaklarda kesin olarak açıklanmamıştır.
- **Bilinen Kullanıcılar / Operatörler:** Raptors; Chapter Master Lias Issodon.
...
-# İlişkili kayıtlar: `raven-guard`, `corvus-corax`, `badab-war`, `tau-empire`