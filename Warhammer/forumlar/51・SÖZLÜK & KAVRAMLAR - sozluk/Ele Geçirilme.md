...
Bir iblisin bir bedeni (canlı ya da makine) ele geçirip kontrol altına alması.

Ele geçirilme (Daemonic Possession), bir Warp iblisinin gerçek uzaya sızmak için zayıf ya da korunmasız bir bedeni ele geçirip onu bir kuklaya, bir konağa çevirmesidir. İblisler kendi başlarına gerçekliğe kalıcı biçimde giremez; ele geçirme, onların en yaygın ve en sinsi giriş yollarından biridir.
