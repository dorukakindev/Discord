...
Engizisyon'un iblis avcısı kolu; Grey Knights'ı askeri gücü olarak kullanır.

Ordo Malleus (Çekiç Tarikatı), Engizisyon'un en gizli ve en tehlikeli koludur; Warp'ın iblisleriyle ve Kaos'la doğrudan savaşmaya adanmıştır. Adındaki "Malleus" (çekiç), iblislere indirilen darbeyi simgeler. Bu kolun üyeleri, galaksinin en yasak ve en tehlikeli bilgisini (iblislerin doğasını, nasıl çağrıldıklarını ve nasıl yok edildiklerini) inceler.
...
Ordo Malleus, Inquisition'un 'daemon avcısı' koludur — Grey Knights'ın komuta eden ve Warp'ın iblis tehdidine karşı uzmanlaşmış en gizli ordo. Malleus'un Inquisitor'ları, daemonları anlama, sınıflandırma ve yok etme konusunda İmparatorluk'un en bilgili uzmanlarıdır ve Grey Knights'ı (İmparatorluk'un en seçkin anti-daemon birliğini) yönetirler.
