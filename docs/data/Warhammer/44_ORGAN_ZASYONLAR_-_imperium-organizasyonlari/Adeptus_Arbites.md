...
# Adeptus Arbites
*İmparatorluk Yargısı*

İmparatorluk yasasının acımasız uygulayıcıları; gezegenel yönetimlerden bağımsız, isyanı bastıran kolluk gücü.

Adeptus Arbites, İmparatorluk yasasının (Lex Imperialis) acımasız uygulayıcılarıdır; gezegen yönetimlerinden tamamen bağımsız, doğrudan Terra'ya bağlı olarak çalışan, galaksi çapında bir kolluk gücüdür. Yerel valilerin ya da soyluların etkisinden bağımsız olmaları, onları İmparatorluk düzeninin tarafsız (ama acımasız) bekçileri yapar.
