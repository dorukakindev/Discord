...
Sinaptik biyoformların taşıdığı, kendi iradesiyle kıvranan canlı bir kırbaç organizmasıdır; taşıyıcısının eylemlerinden bağımsız olarak savrulur, kurbanı kemik kancalarıyla yırtar ya da sararak kolay av haline getirir.

- **Kategori:** Symbiote yakın dövüş organizması — <#1551629122592182382>
- **Fraksiyon:** Tyranids
- **Dönem:** M41'in ikinci yarısından Era Indomitus'a
- **Köken:** Hive Mind'ın biyolojik tasarımıdır; taşıyıcıyla bütünleşik ayrı bir organizmadır.
- **Teknik / Biyolojik Özellikler:** Küçük gövdesi kırbaç sapını oluşturan kemik bir boru içinde yaşar; bir ile üç arasında kas ve tendon tentakülü kendi başlarına, kaçınılmayacak ve savuşturulamayacak hızda vurur. Yaratık, kurbanlarından kestiği etle beslenir.
- **Bilinen Kullanıcılar / Operatörler:** Hive Tyrant'ları, Tyrant Guard'lar ve Tyranid Warrior'ları.
- **Önemli Olaylar:** Kaynaklarda tek bir olayla özdeşleşmez.
- **Kanon Notu:** Imperium kayıtlarında Verbero Verber olarak geçer.
