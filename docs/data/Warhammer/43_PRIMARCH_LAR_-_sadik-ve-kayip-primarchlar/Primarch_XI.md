...
*Kayıtlardan Silinmiş On Birinci Primarch*

Emperor'un yirmi Primarch'ından on birincisi. Adı, yüzü, Legion'ı ve kaderi Imperium'un tüm kayıtlarından silinmiştir. Hakkında bilinen neredeyse tek kesin şey, Horus Heresy'den önce ortadan kaldırıldığı ve bu olayın o kadar karanlık olduğu ki, kardeşlerinin bile onu anmaktan kaçındığıdır. Games Workshop bu gizemi bilinçli olarak açık bırakır.

- **Kategori:** Primarch (kayıp / silinmiş)
- **Fraksiyon:** Bilinmiyor — XI Legion
- **Dönem:** Great Crusade (M30) — Heresy öncesinde kayboldu
- **Köken:** Bilinmiyor
- **Durum:** Bilinmiyor; kayıtlardan kasıtlı olarak silindi

## Bilinen Gerçekler
Yayımlanmış kanonda Primarch XI hakkında kesin olarak bilinenler çok sınırlıdır:
...
Horus Heresy romanları, Primarch XI hakkında dolaylı ama önemli ipuçları sunar:
...
## Hayran Teorileri
Primarch XI hakkında hayran topluluğunda birçok teori dolaşır:
