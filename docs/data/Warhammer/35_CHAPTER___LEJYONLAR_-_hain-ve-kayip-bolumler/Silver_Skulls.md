...
- **Primarch:** (bilinmiyor)
- **Ana Dünya:** Varsavia
- **Color:** Gümüş, kafatası
- **Tactics:** Kehanetle zamanlanmış saldırılar, fal-temelli strateji, agresif hücum.
...
Bu uygulama, dışarıdan tehlikeli bir batıl inanç gibi görünür ve onları zaman zaman Engizisyon'un şüpheli bakışlarına maruz bırakır; psişik kehanete bu kadar bağımlı olmak, yozlaşma riski taşır. Ama Silver Skulls'un savaş kayıtları başarılıdır; kehanetlerine olan inançları, onlara savaşta sarsılmaz bir kararlılık ve doğru anı yakalama becerisi kazandırır. Bekledikleri o "kutlu an"da vurduklarında, etkileri yıkıcıdır.
