...
Iron Hands soyundan gelen, et ile makineyi birleştiren ve kendi Mechanicus benzeri kültürünü kuran bağımsız bir chapter.

- **Kuruluş:** Sonraki Kuruluş
- **Bağlılık:** Sadık
- **Primarch:** Ferrus Manus (Iron Hands)
- **Ana Dünya:** Gezici filo / Medusa soyu
- **Color:** Bordo-çelik
- **Tactics:** Ağır zırh ve makine entegrasyonu, soğukkanlı dayanıklılık, biyonik üstünlük.
- **Kanon Sınıfı:** A — resmî kaynak

## Kayıt

Sons of Medusa (Medusa'nın Oğulları), primarch Ferrus Manus'un Iron Hands lejyonu soyundan gelen, ama atalarının felsefesini kendi yönüne taşıyan bağımsız bir chapter'dır; et ile makinenin birleşimini, soğukkanlı dayanıklılığı ve duygulardan arınmış mantığı yüceltirler. Iron Hands gibi, "et zayıftır" inancını paylaşırlar.
...
Sons of Medusa, Adeptus Mechanicus ile alışılmadık derecede yakın bir ilişkiye ve neredeyse onlarınki kadar derin bir makine-kültürüne sahiptir; kendi içlerinde, savaşçı kardeşlik ile teknoloji-rahipliği arasında bir denge kurarlar. Iron-Father'ları (hem savaşçı hem teknolog liderleri) bu kültürün merkezindedir. Soğuk, mantıklı ve son derece dayanıklı savaşçılardır; duygu, onlar için bir zayıflık, biyonik güç ise bir erdemdir.
