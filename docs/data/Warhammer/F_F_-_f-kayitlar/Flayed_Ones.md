...
Et maskeli Necron'lar — derilerini insanlardan kesip üstlerine giyen, yaşayan ete aç delirmiş savaşçılar. Necron olmanın 'yanlışlığı' onları bu çıldırtıcı duruma getirdi.
...
-# İlişkili kayıtlar: `necrons`, `canoptek`, `destroyer-cult`, `cryptek`