...
Karanlık Teknoloji Çağı'ndan kalma ısı-ışını ağır silahı; kurbanını içten tutuşturup kül sütununa çevirir ve bu kül yanındakilere sıçrar. Üretim sırrı büyük ölçüde kayıptır.
...
## Teknik Özellikler
- Tip: Imperium volkite silahı — ağır destek versiyonu
- Etki: termal ışın dokuyu yakar; isabetli vuruş zincirleme yanma üretir
- Taşıyıcı: ağır silah takımları ve Mechanicus destek birimleri
