...
Zehir ustası savaşçı xeno kastı; mantis-benzeri avcılardan oluşan, binlerce yıldır Tau sınırında görülen esrarengiz tür.

- **Kategori:** Xenos türü
- **Fraksiyon:** Bağımsız
- **Dönem:** Kayıt dışı / M41 öncesi
- **Köken:** T'au sınırının dış halkası
- **Teknik / Biyolojik Özellikler:** Mantis benzeri avcılar; vücutları doğal toksinlerle dolu, 'zehirli kılıç' doktrinli savaş kastı.
- **Bilinen Kullanıcılar / Operatörler:** Scythian savaşçı kastları
- **Önemli Olaylar:** İmparatorluk'un ilk temasları kaybedilen gözlem istasyonlarıyla başlar.
