...
Bir karakter ağır bir kötülük işlediğinde Kara Güçler'in dikkatini çektiği an; başarısız bir sınama, yozlaşmaya ve canavarlığa doğru atılmış bir adımdır. Tekrarlanan başarısızlıklar karakteri yavaşça bir Karanlık Lord'a dönüştürebilir.
...
Güç Sınaması, Ravenloft'ta kötülüğün kademeli ve baştan çıkarıcı doğasını temsil eder. O, hiç kimsenin tek bir anda canavar olmadığını, ama her karanlık seçimin bir sonrakini kolaylaştırdığını gösterir. Mekanik, oyunculara basit ama amansız bir gerçeği hatırlatır: bu evrende kötülük cezasız kalmaz, ama cezası çoğu zaman bir yıldırım değil, yavaş yavaş kendi olmaktan çıkmaktır. Kara Güçler izler, sayar ve sabırla bekler; ve dikkatlerini bir kez kazanan, onu kolay kolay üzerinden atamaz.

## Ayırt Edici Özellikler

- Ağır bir kötü eylem, Kara Güçler'in dikkatini karaktere çeker
- Başarısız bir sınama, yozlaşmaya doğru bir adımdır
- Çoğu zaman bir Kara Armağan'la ödüllendirip aynı anda lekeler
- Tekrarlanan başarısızlıklar karakteri canavarlığa sürükler
- Yeterince ileri giden bir kurban, sonunda kendi diyarına hapsedilebilir
