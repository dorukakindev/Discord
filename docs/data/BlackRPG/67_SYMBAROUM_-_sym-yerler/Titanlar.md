...
Davokar'ı çevreleyen ve bölgeyi sınırlayan görkemli dağ silsilesi; ormanın doğal sınırlarından biri ve kuzeyin tehlikeli diyarlarını çevre topraklardan ayıran aşılması güç doğal duvar.

- **Tür:** Plato
- **Bölge:** Davokar ile çevre toprakların sınırını çizen dağlar
...
Titanlar, Symbaroum dünyasında sınırın, yalıtımın ve doğanın görkeminin simgesidir; Davokar'ın tehlikeli diyarını çevreleyen ve onu çevre topraklardan ayıran muazzam bir doğal duvar. Bu dağlar, kuzeyin vahşi dünyasını hem korur hem de sınırlar; sarp zirveleriyle, çetin geçitleriyle ve heybetli duruşlarıyla, ormanın karanlığına bakan ve onu çerçeveleyen, Symbaroum coğrafyasının görkemli ve aşılması güç sınır taşıdır.

## Özellikler

- Davokar bölgesini çevreleyen görkemli dağ silsilesi
- Ormanın doğal sınırlarından birini oluşturur
- Kuzeyin tehlikeli diyarlarını çevre topraklardan ayırır
- Sarp yamaçları ve geçitleriyle aşılması güç doğal duvar
- Davokar ve barbar topraklarının coğrafi sınır taşı
