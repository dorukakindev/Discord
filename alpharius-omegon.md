...
Bu kanal okunurken özel bir ihtiyat gerekir. Alpharius Omegon'a dair kayıtların önemli bir bölümü Legion'un kendi yaydığı yanıltmalar, çelişkili tanıklıklar ya da bilerek ortada bırakılmış izlerdir. Yayınlar da bu belirsizliği bilinçli olarak korur. Legion'un kurumsal tarihi ve 40K'daki örgütlenmesi `alpha-legion` kanalında işlenir.
...
**Çapraz:** `alpha-legion`, `horus-heresy`, `rogal-dorn`, `roboute-guilliman`, `raven-guard`, `white-scars`, `primarchs`, `siege-of-terra`
