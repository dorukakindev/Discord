...
Bu kanal Mortarion'u bir kişi olarak ele alır. Legion'un kurumsal tarihi ve Plague Company düzeni `death-guard`, Nurgle'ın doğası `nurgle` kanalında işlenir.
...
**Çapraz:** `death-guard`, `nurgle`, `plague-wars`, `roboute-guilliman`, `jaghatai-khan`, `horus-heresy`, `primarchs`, `ultramar`
